...
def load_physiology(window_size=1000):
    x_ras = pd.read_csv(
        'data/70/DKD_drug-0_glu-7_infection-1_renal-impaired.csv')
    x_cardio = pd.read_csv(
        'data/70/CARDIO_drug-0_glu-7_infection-1_renal-impaired.csv', index_col=0)
    x_cardio = x_cardio[['t', 'Pra', 'Prv', 'Pla', 'Plv', 'Ppap',
                         'Ppad', 'Ppa', 'Ppc', 'Ppv', 'Psa', 'Psap', 'Psc', 'Psv']]
    x_ras.drop(['angII_norm', 'IR'], axis=1, inplace=True)
    x_cardio.columns = ['t2', 'Pra', 'Prv', 'Pla', 'Plv', 'Ppap',
                        'Ppad', 'Ppa', 'Ppc', 'Ppv', 'Psa', 'Psap', 'Psc', 'Psv']
    tx_ras = x_ras['t']
    ...
    for batch in range(x.shape[0] - 2 * window_size + 1):
        ...
        t_list_1.append(
            t1[batch + window_size - 1:batch + 2 * window_size - 3])
        t_list_2.append(
            t2[batch + window_size - 1:batch + 2 * window_size - 3])
    ...
    elist = [
        ('t', 't'), ('angI', 'angI'), ('Inhibition',
                                       'Inhibition'), ('Renin', 'Renin'),
        ('AGT', 'AGT'), ('angII', 'angII'),
        ('diacid', 'diacid'), ('ang17', 'ang17'), ('at1r',
                                                   'at1r'), ('at2r', 'at2r'), ('ACE2', 'ACE2'),
        ('t', 'angI'), ('t', 'Inhibition'), ('t',
                                             'Renin'), ('t', 'AGT'), ('t', 'angII'), ('t', 'diacid'),
        ('t', 'ang17'), ('t', 'at1r'), ('t', 'at2r'), ('t', 'ACE2'),
        ('AGT', 'angI'), ('Renin', 'angI'), ('angI',
                                             'ang17'), ('angI', 'angII'), ('diacid', 'angII'),
        ('angII', 'Renin'),
        ('angII', 'ang17'), ('angII', 'at1r'), ('angII',
                                                'at2r'), ('ACE2', 'ang17'), ('ACE2', 'angI'),

        ('t2', 't2'), ('t2', 'Pra'), ('t2', 'Prv'), ('t2', 'Pla'), ('t2', 'Plv'), ('t2', 'Ppap'), ('t2', 'Ppad'), ('t2',
                                                                                                                   'Ppa'), ('t2', 'Ppc'), ('t2', 'Ppv'), ('t2', 'Psa'),  ('t2', 'Psap'), ('t2', 'Psc'), ('t2', 'Psv'),
        ('Pra', 'Pra'), ('Pra', 'Prv'), ('Pra', 'Pla'), ('Pra', 'Plv'), ('Pra', 'Ppap'), ('Pra', 'Ppad'), ('Pra',
                                                                                                           'Ppa'), ('Pra', 'Ppc'), ('Pra', 'Ppv'), ('Pra', 'Psa'),  ('Pra', 'Psap'), ('Pra', 'Psc'), ('Pra', 'Psv'),
        ('Prv', 'Prv'), ('Prv', 'Pla'), ('Prv', 'Plv'), ('Prv', 'Ppap'), ('Prv', 'Ppad'), ('Prv', 'Ppa'), ('Prv',
                                                                                                           'Ppc'), ('Prv', 'Ppv'), ('Prv', 'Psa'),  ('Prv', 'Psap'), ('Prv', 'Psc'), ('Prv', 'Psv'),
        ('Pla', 'Pla'), ('Pla', 'Plv'), ('Pla', 'Ppap'), ('Pla', 'Ppad'), ('Pla', 'Ppa'), ('Pla',
                                                                                           'Ppc'), ('Pla', 'Ppv'), ('Pla', 'Psa'),  ('Pla', 'Psap'), ('Pla', 'Psc'), ('Pla', 'Psv'),
        ('Pra', 'Pra'), ('Pra', 'Ppap'), ('Pra', 'Ppad'), ('Pra', 'Ppa'), ('Pra', 'Ppc'), ('Pra',
                                                                                           'Ppv'), ('Pra', 'Psa'),  ('Pra', 'Psap'), ('Pra', 'Psc'), ('Pra', 'Psv'),
        ('Ppap', 'Ppap'), ('Ppap', 'Ppad'), ('Ppap', 'Ppa'), ('Ppap', 'Ppc'), ('Ppap',
                                                                               'Ppv'), ('Ppap', 'Psa'), ('Ppap', 'Psap'), ('Ppap', 'Psc'), ('Ppap', 'Psv'),
        ('Ppad', 'Ppad'), ('Ppad', 'Ppa'), ('Ppad', 'Ppc'), ('Ppad',
                                                             'Ppv'), ('Ppad', 'Psa'), ('Ppad', 'Psap'), ('Ppad', 'Psc'), ('Ppad', 'Psv'),
        ('Ppa', 'Ppa'), ('Ppa', 'Ppc'), ('Ppa', 'Ppv'), ('Ppa',
                                                         'Psa'), ('Ppa', 'Psap'), ('Ppa', 'Psc'), ('Ppa', 'Psv'),
        ('Ppc', 'Ppc'), ('Ppc', 'Ppv'), ('Ppc', 'Psa'), ('Ppc',
                                                         'Psap'), ('Ppc', 'Psc'), ('Ppc', 'Psv'),
        ('Ppv', 'Ppv'), ('Ppv', 'Psa'), ('Ppv',
                                         'Psap'), ('Ppv', 'Psc'), ('Ppv', 'Psv'),
